...
subj_id = 'test5'
run = 'test_songs'
subject_filename = '/Users/jamalw/Desktop/PNI/music_event_structures/subjects/' + subj_id + '/' + subj_id + '_' + 'main_experiment2' + run + '.log'
...
song_dir = '/Users/jamalw/Desktop/PNI/music_event_structures/' + run + '.npy'
